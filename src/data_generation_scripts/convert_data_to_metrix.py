...
if __name__=="__main__":
  ...
  argParser.add_argument("-dp", "--data_path", type=Path, default=Path("/dataset/Keystrokes/files"), help="dataset path")
  argParser.add_argument("-sp", "--save_path", type=Path, default=Path("/dataset/full_matrix_data.csv"), help="dataset path")
  ...
  argParser.add_argument("-nu", "--num_of_users", type=int, default=16, help="num of strokes to use in split")
